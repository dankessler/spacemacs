...
- [[#install][Install]]
  ...
  - [[#org-latex-preview-support][Org-latex-preview support]]
...
** Org-latex-preview support
To install the development version of org-mode with org-latex-preview support,
set the variable =org-enable-latex-preview-support= to =t=.

#+BEGIN_SRC emacs-lisp
  (setq-default dotspacemacs-configuration-layers
   '((org :variables org-enable-latex-preview-support t)))
#+END_SRC

Spacemacs automatically handles the build process (version file and autoloads generation)
when this feature is enabled.

See [[https://abode.karthinks.com/org-latex-preview/][org-latex-preview]] documentation for more information.
